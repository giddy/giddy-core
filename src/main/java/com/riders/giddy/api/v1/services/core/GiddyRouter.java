...
import com.riders.giddy.api.v1.services.core.routing.CustomAstar;
import com.riders.giddy.api.v1.services.core.routing.RoutingAlgorithmFactoryCustom;
import com.riders.giddy.api.v1.services.core.utils.GiddyScoreHelper;
...
public class GiddyRouter {
    ...
    private final Map<StatNames, Float> DEFAULT_GAUGE = GiddyScoreHelper.buildStatsMap(1, 1, 1, 1, 1, 1);
