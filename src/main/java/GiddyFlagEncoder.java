 ...
 */
public class GiddyFlagEncoder extends BikeFlagEncoder {

    private EncodedDoubleValue reverseSpeedEncoder;

    public GiddyFlagEncoder()
    {
        super();
    }

    public GiddyFlagEncoder( String propertiesStr )
    {
        super(new PMap(propertiesStr));
    }

    public GiddyFlagEncoder( PMap properties )
    {
        super(properties);
    }

    public GiddyFlagEncoder( int speedBits, double speedFactor, int maxTurnCosts )
    {
